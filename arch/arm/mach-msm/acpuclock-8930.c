...
static struct l2_level l2_freq_tbl[] __initdata = {
    ...
    [1]  = { {  288000, PLL_8, 0, 0x00 },  LVL_LOW, 1050000, 1 },
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
    { 1, {   192000, PLL_8, 0, 0x00 }, L2(0),   872500 },
    { 1, {   288000, PLL_8, 0, 0x00 }, L2(0),   875000 },
        { 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   877500 },
        ...
        { 1, {   756000, HFPLL, 1, 0x1C }, L2(10),  975000 },
        { 1, {   810000, HFPLL, 1, 0x1E }, L2(10), 1000000 },
        { 1, {   864000, HFPLL, 1, 0x20 }, L2(10), 1012500 },
        ...
        { 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1112500 },
        { 1, {  1188000, HFPLL, 1, 0x2C }, L2(15), 1125000 },
        { 1, {  1242000, HFPLL, 1, 0x2E }, L2(15), 1137500 },
        { 1, {  1296000, HFPLL, 1, 0x30 }, L2(15), 1150000 },
        { 1, {  1350000, HFPLL, 1, 0x32 }, L2(15), 1162500 },
        { 1, {  1404000, HFPLL, 1, 0x34 }, L2(15), 1175000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = { 
    ...
    { 1, {   288000, PLL_8, 0, 0x00 }, L2(0),   850000 },
        ...
        { 1, {   756000, HFPLL, 1, 0x1C }, L2(10),  975000 },
        { 1, {   810000, HFPLL, 1, 0x1E }, L2(10),  987500 },
        { 1, {   864000, HFPLL, 1, 0x20 }, L2(10), 1000000 },
        { 1, {   918000, HFPLL, 1, 0x22 }, L2(10), 1012500 },
        { 1, {   972000, HFPLL, 1, 0x24 }, L2(10), 1025000 },
        { 1, {  1026000, HFPLL, 1, 0x26 }, L2(10), 1037500 },
        { 1, {  1080000, HFPLL, 1, 0x28 }, L2(15), 1050000 },
        { 1, {  1134000, HFPLL, 1, 0x2A }, L2(15), 1062500 },
        { 1, {  1188000, HFPLL, 1, 0x2C }, L2(15), 1075000 },
        { 1, {  1242000, HFPLL, 1, 0x2E }, L2(15), 1087500 },
        { 1, {  1296000, HFPLL, 1, 0x30 }, L2(15), 1100000 },
        { 1, {  1350000, HFPLL, 1, 0x32 }, L2(15), 1112500 },
        { 1, {  1404000, HFPLL, 1, 0x34 }, L2(15), 1125000 },
